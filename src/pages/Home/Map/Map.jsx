...
const Map = () => {
    return (
        <div className='md:h-[150px] w-full h-full my-11 bg-secondary' style={{ backgroundImage: `url('https://validthemes.live/themeforest/edukat/assets/img/map.svg')` }}>
            <div className="md:h-[150px] text-white bg-black flex justify-center items-center bg-opacity-40">
